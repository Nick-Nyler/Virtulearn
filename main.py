...
from lib.cli import perform_initdb, perform_dropdb, add_instructor_cli, list_instructors_cli, find_instructor_cli, delete_instructor_cli, add_course_cli, list_courses_cli, find_course_cli, delete_course_cli, assign_course_cli, add_enrollment_cli, list_enrollments_cli, find_enrollment_cli, delete_enrollment_cli
import sys
